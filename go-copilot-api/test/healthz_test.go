...
func TestHealthzEndpoint(t *testing.T) {
	...
	dummyTokenManager, _ := copilot.NewTokenManager(context.Background(), nil)
	dummyModelsCache, _ := copilot.NewModelsCache(context.Background(), dummyTokenManager, 1*time.Hour, nil)
